...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    //   // Bounce off edges
    //   if (autoX1 <= 0 || autoX1 >= window.innerWidth) dx = -dx;
    //   if (autoY1 <= 0 || autoY1 >= window.innerHeight) dy = -dy;

    //   createSplash(autoX1, autoY1);
    // }, 10);
  ...
  return (
    <div className="fixed left-0 top-0 w-[100vw] h-[100vh] overflow-hidden z-0 pointer-events-none">
